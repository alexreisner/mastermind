...
Disable root SSH login:
  ...
  sudo restart ssh       # for Lucid
  /etc/init.d/ssh reload # for pre-Lucid
...
=== 1.8 Ruby Enterprise Edition with Passenger
...
=== 1.9.2
  ...
  sudo apt-get install libreadline-ruby1.9

  cd /usr/local/src
  sudo wget http://ftp.ruby-lang.org/pub/ruby/1.9/ruby-1.9.2-p180.tar.gz
  tar xf ruby-1.9.2-p180.tar.gz
  cd ruby-1.9.2-p180
  ./configure
  make
  sudo make install
...
Create symlinks and restart Apache:
